				...
				(t.prototype.set_default_text = function () {
					return (
						...
						(this.results_none_found =
							this.form_field.getAttribute('data-no_results_text') || this.options.no_results_text || t.default_no_result_text)
					);
				}),
		...
		(s = (function (s) {
			...
			return (
				...
				(n.prototype.set_up_html = function () {
					...
					return (
						...
						this.form_field_jq /*.hide()*/
							.css({ opacity: 0, 'pointer-events': 'none', position: 'absolute', height: '30px' })
				...
				(n.prototype.search_results_mousewheel = function (t) {
					var e;
					if (
						(t.originalEvent && (e = t.originalEvent.deltaY || -t.originalEvent.wheelDelta || t.originalEvent.detail), null != e)
					)
						return (
							t.preventDefault(),
				...
				(n.prototype.set_tab_index = function (t) {
					var e = this.form_field.tabIndex;
					this.form_field.tabIndex = -1;
					if (e) return (this.search_field[0].tabIndex = e);
				}),
					...
					if (this.is_multiple) {
						for (
							r = { position: 'absolute', left: '-1000px', top: '-1000px', display: 'none', whiteSpace: 'pre' },
								s = 0,
								i = (o = ['fontSize', 'fontStyle', 'fontWeight', 'fontFamily', 'lineHeight', 'textTransform', 'letterSpacing'])
									.length;
							s < i;
							s++
						)
